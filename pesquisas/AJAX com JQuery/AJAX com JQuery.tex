...
\end{center}
\section{Introdução}
Para suprir a necessidade de consumir recursos do servidor sem que a página precise ser carregada noovamente, utilizamos o conceito de Ajax durante o desenvolvimento de sites e sistemas web em geral. Ajax pode ser definido como um conjunto de técnicas com a utilização de JavaScript para carregar informações de forma assíncrona.
...
O jQuery oferece uma gama de funções para trabalhar as requisições AJAX.
