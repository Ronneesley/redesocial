...
A função HTML() tem dois usos distintos: Pode-se usá-la para obter o conteúdo em html de um determinado elemento e para definir esse conteúdo. Na primeira forma, basta que o método seja invocado sem a passagem de parâmetros, na segunda deve-se passar o conteúdo total do elemento. 
\vspace{0.5cm}
