...
\requisitoFuncional
 ...
 {Gusttavo Nunes Gomes}
 %Especificação do Requisito
 { Ao realizar inscrição em um evento, o usuário é automticamente inscrito em suas atividades, desde que não possua restrição de horários, como múltiplas atividades no mesmo horário, sendo estas necessitando o preenchimento manual do usuário. A inscrição automática em todas as atividades pode ser alterada posteriormente pelo usuário.
 }