\chapter{Especificação de requisitos}
 ...
 { O sistema deve fornecer um arquivo para download com as normas de cadastro de artigos cietíficos com fácil acesso do usuário.
     ...
     \requisitoFuncional{RF21}
 %Nome do Requisito
 {O sistema deve opção para o usuário concordar ou não as normas de envio}
 %Fonte do Requisito
 {Andrey Silva Ribeiro}
 %Local e/ou Reunião
 {Laboratório 2 do IF Goiano Ceres}
 ...
 {Andrey Silva Ribeiro}
 %Especificação do Requisito
 { O sistema deve opção clicável para o usuário concordar ou não as normas de envio, caso não concorde o artigo nao é cadastrado.
 }