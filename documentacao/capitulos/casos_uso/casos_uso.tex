...
\begin{itemize}
	...
	\item Ao selecionnar a opção seus álbuns conforme a (Figura \ref{figura:Seus_album}) o sistema mostra todos seus álbuns da rede socil e o usuário pode( visualizar, editar e deletar) as fotos do álbuns.
