...
\begin{itemize}
	...
	\item Usuário tem a opção de anexar uma foto para seu perfil usando sua \textit{webcam} ou faz \textit{upload} de uma foto para o sistema como mostra a Figura \ref{figura:3_passo_cadastro_usuarios}; %falta a foto do protótipo da 3a etapa
...
\begin{itemize}
	...
	\item O sistema mostra amigos \textit{online} ou \textit{offline} (Figura \ref{figura:chat_ativos});
...
\begin{itemize}
	...
	\item O sistema abre o \textit{chat}, mostrando ao usuário seus amigos que estão \textit{online}  e \textit{offline}, igual a (Figura \ref{figura:chat_ativos});	
