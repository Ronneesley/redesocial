...
%Pós-condições
{O comentário é postado}
%Fluxo Básico
{
\begin{itemize}

\item Usuário identifica uma postagem do seu interesse;
\item O usuário digita seu comentario (Figura 7);
\item O Usuário clica em enviar e publica seu comentário (Figura7).
...
\begin{itemize}
	\item Exibe uma mensagem de erro "a conexão com o servidor falhou!".
	\item Volta para a tela anterior.
\end{itemize}

\item Problemas com sua conexão com a Internet.
\begin{itemize}
	\item Exibe uma mensagem de erro "a conexão com a Internet falhou!".
	\item Volta para a tela anterior.
\end{itemize}
...
{
\begin{itemize}
	\item Usuário: O usuário deseja sair da conta clicando no ícone ao lado da foto do perfil selecionando a opção sair, como mostra a Figura \ref{figura:7}.
	\item Usuário: Volta para a tela inicial do sistema de autenticação.
\end{itemize}

}
%Pré-Condições
{O usuário faz autenticação ao sistema)}
%Pós-condições
{}
%Fluxo Básico
{
\begin{itemize}
	...
	\item Usuário faz autenticação  ao sistema.
\end{itemize}
}
%Fluxo Alternativo
{
...
{
\begin{itemize}
	\item Usuário: Clicar no campo de pesquisar.
	\item Usuário: Escrever o nome da pessoa/grupo que deseja pesquisar.
	\begin{itemize}
		\item Sistema: Ao pesquisar uma pessoa/grupo o sistema abre a janela de pessoa/grupo encontrados.
	\end{itemize}
	\item Usuário: Seleciona o nome da pessoa/grupo de seu interece.
	\item Sistema: O usúario é redirecionado para a pagina de perfil da pessoa ou para a pagina do grupo que foi selecionado.
\end{itemize}
}
%Fluxo Alternativo
{
\begin{itemize}
	\item Usuário desconectado.
	\begin{itemize}
		\item O usuário é retornado para a tela de login (Figura:\ref{login})
	\end{itemize}
	\item Problemas com resposta do servidor ao pesquisar uma pessoa/grupo.
	\begin{itemize}
		\item Exibir a mensagem de falha ao conectar ao servidor.
	\end{itemize}
	\item Usuário pesquisa um nome que não existe na rede social.
	\begin{itemize}
		\item Exibir mensagem de pessoa/grupo não encontrado.
	\end{itemize}
	\item Usuário não esta conectado a internet.
	\begin{itemize}
		\item Exibir mensagem de falha na conexão.
	\end{itemize}
\end{itemize}
}
%Frequência de Ocorrência
