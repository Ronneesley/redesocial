...
\begin{itemize}
	...
	\item Usuário tem a opção de anexar uma foto para seu perfil usando sua webcam ou faz \textit{upload} de uma foto para o sistema.% como mostra a Figura \ref{figura:[...]}. %falta a foto do protótipo da 3a etapa
