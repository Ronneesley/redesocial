...
public class PostagemMultimidiaDAO extends DAOBase {
    ...
    public void alterar(PostagemMultimidia dto, PostagemMultimidia dtoNovo) throws Exception {
        ...
        PreparedStatement pstmt;
        pstmt = conexao.prepareStatement("update postagens_multimidias set postagem = ?, multimidia = ? "
                + "where postagem = ? and multimidia = ?");
...
>>>>>>> 31fe9f3f5e4d658eb3e845de976f8436fbfad15f
