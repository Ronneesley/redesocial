...
-- -----------------------------------------------------
-- Table `redesocial`.`instituicao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `redesocial`.`instituicao` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(80) NOT NULL,
  `cidade` INT NOT NULL,
  `usuario` INT NOT NULL,
  `endereco` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`, `cidade`, `usuario`),
  INDEX `fk_instituicao_cidades1_idx` (`cidade` ASC),
  INDEX `fk_instituicao_usuarios1_idx` (`usuario` ASC),
  CONSTRAINT `fk_instituicao_cidades1`
    FOREIGN KEY (`cidade`)
    REFERENCES `redesocial`.`cidades` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_instituicao_usuarios1`
    FOREIGN KEY (`usuario`)
    REFERENCES `redesocial`.`usuarios` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `redesocial`.`eventos` (
  ...
  `instituicao` INT UNSIGNED NULL,
  `endereco` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `usuario_responsavel_idx` (`responsavel` ASC),
  INDEX `fk_eventos_instituicao1_idx` (`instituicao` ASC),
  CONSTRAINT `usuario_responsavel`
    FOREIGN KEY (`responsavel`)
    REFERENCES `redesocial`.`usuarios` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_eventos_instituicao1`
    FOREIGN KEY (`instituicao`)
    REFERENCES `redesocial`.`instituicao` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = '	';
