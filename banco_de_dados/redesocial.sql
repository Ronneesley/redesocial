...
CREATE TABLE IF NOT EXISTS `redesocial`.`presenca_evento` (
  ...
  INDEX `fk_presenca_evento_eventos1_idx` (`eventos` ASC),
  INDEX `fk_presenca_evento_usuarios1_idx` (`usuarios` ASC),
  PRIMARY KEY (`eventos`, `usuarios`),
...
CREATE TABLE IF NOT EXISTS `redesocial`.`presenca_atividade` (
  ...
  INDEX `fk_presenca_atividade_usuarios1_idx` (`usuarios_id` ASC),
