...
CREATE TABLE IF NOT EXISTS `redesocial`.`relacionamentos` (
  ...
  `usuarios` INT NOT NULL,
  `tipo` INT NOT NULL,
  PRIMARY KEY (`usuarios`, `usuarios`),
  INDEX `fk_usuarios_has_usuarios_usuarios2_idx` (`usuarios` ASC),
  INDEX `fk_usuarios_has_usuarios_usuarios1_idx` (`usuarios` ASC),
...
CREATE TABLE IF NOT EXISTS `redesocial`.`aportes` (
  ...
  PRIMARY KEY (`id`),
  INDEX `postagem_idx` (`postagem` ASC),
